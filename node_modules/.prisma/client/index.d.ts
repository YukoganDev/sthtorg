...
export namespace Prisma {
  ...
  */
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    cards<T extends CardFindManyArgs= {}>(args?: Subset<T, CardFindManyArgs>): PrismaPromise<Array<CardGetPayload<T>>| Null>;
  ...
  export type UserPreferencesGetPayload<S extends boolean | null | undefined | UserPreferencesArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    : S extends { select: any } & (UserPreferencesArgs | UserPreferencesFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof UserPreferences ? UserPreferences[P] : never
  } 
      : UserPreferences
  ...
  export interface UserPreferencesDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one UserPreferences that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   */
  export type UserPreferencesFindUniqueOrThrowArgs = UserPreferencesFindUniqueArgsBase
      

  /**
   * UserPreferences: findFirstOrThrow
   */
  export type UserPreferencesFindFirstOrThrowArgs = UserPreferencesFindFirstArgsBase
  ...
  export type CardGetPayload<S extends boolean | null | undefined | CardArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Card :
    S extends undefined ? never :
    ...
    : S extends { select: any } & (CardArgs | CardFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'User' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof Card ? Card[P] : never
  } 
      : Card
  ...
  export interface CardDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): PrismaPromise<Array<CardGetPayload<T>>>
  ...
  export type TermGetPayload<S extends boolean | null | undefined | TermArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Term :
    S extends undefined ? never :
    S extends { include: any } & (TermArgs | TermFindManyArgs)
    ? Term 
    : S extends { select: any } & (TermArgs | TermFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof Term ? Term[P] : never
  } 
      : Term
  ...
  export interface TermDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Term'> extends True ? Prisma__TermClient<TermGetPayload<T>> : Prisma__TermClient<TermGetPayload<T> | null, null>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Term'> extends True ? Prisma__TermClient<TermGetPayload<T>> : Prisma__TermClient<TermGetPayload<T> | null, null>
    ...
    **/
    ...
    ): PrismaPromise<Array<TermGetPayload<T>>>
    ...
    **/
    ...
    ): Prisma__TermClient<TermGetPayload<T>>
    ...
    **/
    ...
    /**
     * Find one Term that matches the filter or throw
     * `NotFoundError` if no matches were found.
    ...
    **/
    findUniqueOrThrow<T extends TermFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, TermFindUniqueOrThrowArgs>
    ): Prisma__TermClient<TermGetPayload<T>>
    ...
    **/
    findFirstOrThrow<T extends TermFindFirstOrThrowArgs>(
      args?: SelectSubset<T, TermFindFirstOrThrowArgs>
    ): Prisma__TermClient<TermGetPayload<T>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__TermClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  /**
   * Term base type for findUnique actions
   */
  export type TermFindUniqueArgsBase = {
    /**
   ...
   * Term: findUnique
   */
  export interface TermFindUniqueArgs extends TermFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * Term base type for findFirst actions
   */
  export type TermFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Term
     * 
    **/
   ...
   * Term: findFirst
   */
  export interface TermFindFirstArgs extends TermFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
   ...
   */
  export type TermFindUniqueOrThrowArgs = TermFindUniqueArgsBase
      

  /**
   * Term: findFirstOrThrow
   */
  export type TermFindFirstOrThrowArgs = TermFindFirstArgsBase
  ...
  export type UserPreferencesScalarWhereWithAggregatesInput = {
    ...
    id?: IntWithAggregatesFilter | number
    pageScale?: IntWithAggregatesFilter | number
  }
  ...
  export type TermScalarWhereWithAggregatesInput = {
    ...
    id?: IntWithAggregatesFilter | number
    term?: StringWithAggregatesFilter | string
  ...
  export type UserPreferencesUpdateInput = {
    pageScale?: IntFieldUpdateOperationsInput | number
  }
